      ...
      <ScrollView contentContainerStyle={styles.scrollViewContainer}>
        <View style={styles.container}>
          <View style={styles.card}>
            <Image
              source={require("../../../../../assets/User/images/delivery-man (1).png")}
              style={styles.image}
            />
          ...
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.modalRow}>
                ...
                <Text style={styles.Slot}>Selected Water Type</Text>
              </View>

              <View style={styles.modalRow1}>
                <Text style={styles.modalText1}>+91 8520089197</Text>
                <Text style={styles.modalSlot}>Mineral</Text>
              </View>
